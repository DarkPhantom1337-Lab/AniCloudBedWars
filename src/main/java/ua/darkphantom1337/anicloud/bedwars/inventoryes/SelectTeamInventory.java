package ua.darkphantom1337.anicloud.bedwars.inventoryes;
...
public class SelectTeamInventory implements InventoryProvider {
    ...
    public void init(Player player, InventoryContents contents) {
        ...
        contents.set(1, 1, ClickableItem.of(new ItemStack(Material.COMPASS), e -> {
            if (e.isLeftClick()) {
                ...
                contents.set(1, 1, ClickableItem.empty(new ItemStack(Material.EMERALD_BLOCK)));
