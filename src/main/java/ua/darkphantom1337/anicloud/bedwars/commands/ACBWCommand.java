        ...
        if (sender instanceof Player) {
                ...
                if (args[0].equals("setGameLobbyLoc")) {
                    if (args.length == 2) {
                        ...
                        AniCloudBedWars.inst().getGameController().getGameConfigurationFile(gameID)
                                .getFileConfiguration().set("ArenaWaitSpawnLoc", player.getLocation());
            ...
            if (args[0].equals("setTeamSpawnLoc")) {
                if (args.length == 3) {
                    ...
                    if (gameConfigurationFile.getStringList("AvailableTeamColors").contains(teamColor)) {
                        gameConfigurationFile.getFileConfiguration().set("Team." + teamColor.toUpperCase() + ".SpawnLoc", player.getLocation());
                ...
                if (args.length == 3) {
                    ...
                    if (gameConfigurationFile.getStringList("AvailableTeamColors").contains(teamColor)) {
                        if (gameConfigurationFile.getStringList("AvailableResources").contains(resourceName)) {
                            gameConfigurationFile.getFileConfiguration().set("Team." + teamColor.toUpperCase() + ".Resource." + resourceName + ".SpawnLoc", player.getLocation());
                            player.sendMessage("§aДанные о игре " + gameID + " сохранены, установите точки спавна остальных команд если таковы есть..."
                                    + "\n- /acbw setTeamSpawnLoc " + gameID + " TeamColor" +
            ...
            if (args[0].equals("setTeamBedSpawnLoc")) {
                if (args.length == 3) {
                    ...
                    GameConfigurationFile gameConfigurationFile = AniCloudBedWars.inst().getGameController().getGameConfigurationFile(gameID);
                    if (gameConfigurationFile.getStringList("AvailableTeamColors").contains(teamColor)) {
                        gameConfigurationFile.getFileConfiguration().set("Team." + teamColor.toUpperCase() + ".BedLoc", player.getLocation());
            ...
            if (args[0].equals("setTeamShopLoc")) {
                if (args.length == 3) {
                    ...
                    GameConfigurationFile gameConfigurationFile = AniCloudBedWars.inst().getGameController().getGameConfigurationFile(gameID);
                    if (gameConfigurationFile.getStringList("AvailableTeamColors").contains(teamColor)) {
                        gameConfigurationFile.getFileConfiguration().set("Team." + teamColor.toUpperCase() + ".ShopLoc", player.getLocation());
            ...
            if (args[0].equals("setTeamUpgradeShopLoc")) {
                if (args.length == 3) {
                    ...
                    GameConfigurationFile gameConfigurationFile = AniCloudBedWars.inst().getGameController().getGameConfigurationFile(gameID);
                    if (gameConfigurationFile.getStringList("AvailableTeamColors").contains(teamColor)) {
                        gameConfigurationFile.getFileConfiguration().set("Team." + teamColor.toUpperCase() + ".UpgradeShopLoc", player.getLocation());
